/*
    ...
    handleRequest() should always handle request related matter.
    processRequest() should always handle process related matter.
...
function processRequest(requestFn) {
    requestFn();
    if (this.closeConnections()) return "ok";
